...
export default class ModifyIssueForm extends Component {
  onUpdate(issue){
    const begin = this.refs.begin.value.trim(),
          ...
          milestone = this.refs.milestone.value.trim();
    IssueAction.update(issue, {begin, end, milestone});
  }
  render(){
    ...
    return <div className="static-modal">
      <Modal.Dialog>
        ...
        <Modal.Footer>
          <button className="btn btn-info" onClick={(e)=> this.onUpdate(issue)}>Update</button>
