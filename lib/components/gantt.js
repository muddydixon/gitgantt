...
export default class Gantt extends Component {
  ...
  render(){
    ...
    // TODO: milestone の due(=end) はある。begin をどうつくるか
    // TODO: 同一 milestone 内で assign されている issue は直列で並べる

    // organizedIssues.forEach((issues)=>{
    //   issues.sort((a, b)=> b.iid - a.iid );
    //   var begin = issues[0].
    //   issues
    // });
    ...
    return <div className="container">
      ...
      <span className="pull-right">{range[1].format("YYYY/MM/DD")}</span>
    </div>
    </div>
      </div>
