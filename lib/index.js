...
app.route("/api/project/:projectId/issue/:issueId")
  .put(handlers.modifyIssue);

app.route("/api/project/:user/:repo/milestone")
  .get(handlers.getMilestones);

app.route("/api/project/:user/:repo/issue")
  .get(handlers.getIssues);

app.route("/api/project/:user/:repo/issue/:issueId")
  .put(handlers.modifyIssue);
